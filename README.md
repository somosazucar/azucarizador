...
If need, Sugarizer server settings could be changed using the [sugarizer.ini](server/sugarizer.ini) config file (you could use another name for this file: just pass the new name as [sugarizer.js](server/sugarizer.js) parameter).
